...
**Stability.** Without of loss of generality take $$ \varepsilon \lt a $$ and denote by $$y(t;c)$$ a solution which at $$t=0$$ is $$ c $$. If $$|c| \lt \varepsilon $$  then we have that $$ |y(t;c) \leq |c| \lt \varepsilon $$ for $$ t \geq 0 $$ because of sign of $$ f $$ .
